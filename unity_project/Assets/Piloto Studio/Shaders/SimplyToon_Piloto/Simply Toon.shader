	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float3 WorldPosition128_g18 = worldPosValue184_g18;
				float4 screenPos = IN.ase_texcoord5;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 ScreenUV183_g18 = (ase_screenPosNorm).xy;
				float2 ScreenUV128_g18 = ScreenUV183_g18;
				float3 worldNormalValue185_g18 = worldNormal85;
				float3 WorldNormal128_g18 = worldNormalValue185_g18;
				float3 localAdditionalLightsLambert14x128_g18 = AdditionalLightsLambert14x( WorldPosition128_g18 , ScreenUV128_g18 , WorldNormal128_g18 );
				float3 temp_output_89_0 = localAdditionalLightsLambert14x128_g18;
...
ASEEND*/
//CHKSM=CEB0885737D2F1E46E9ECCBCAFAE5E1746D73460